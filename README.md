...
|----|----|----|
| Continuous / monetary | [`bcg_utility()`](reference/bcg_utility.html), [`boudreau_utility()`](reference/boudreau_utility.html), [`shp_utility()`](reference/shp_utility.html), [`restricted_canonical_validity()`](reference/restricted_canonical_validity.html), [`sturman_comprehensive()`](reference/sturman_comprehensive.html) | [`multiple_hurdle_selection_staged()`](reference/multiple_hurdle_selection_staged.html), [`compare_selection_systems_staged()`](reference/compare_selection_systems_staged.html), [`selection_utility_from_z()`](reference/selection_utility_from_z.html) |
| Dichotomised / classificatory | [`tr_classic()`](reference/tr_classic.html), [`tr_solve()`](reference/tr_solve.html) | [`tr_multivariate()`](reference/tr_multivariate.html), [`tr_multivariate_equal_cutoff()`](reference/tr_multivariate_equal_cutoff.html), [`group_tr_multivariate()`](reference/group_tr_multivariate.html) |
