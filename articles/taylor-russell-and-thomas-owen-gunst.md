...
`TaylorRussell::TaylorRussell()`, which provided the first widely
available rehabilitation of the Thomas-Owen-Gunst integral after several
decades of computational neglect (Ren & Waller, 2024).
...
`TaylorRussell::TaylorRussell()` (Waller, 2024), and the figures
returned by the two implementations agree to integration tolerance.
